...
export class Engine {
    ...
    best_move(fen, depth) {
        ...
        try {
            ...
            const ret = wasm.engine_best_move(this.__wbg_ptr, ptr0, len0, depth);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    legal_moves_for(fen) {
        ...
        try {
            const ptr0 = passStringToWasm0(fen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.engine_legal_moves_for(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gambit_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
